...
| **Spawns a detached background daemon** (`nohup` on Unix, `spawn(detached: true)` on Windows)  | Tool runs continuously without holding the terminal                           | Yes — persistence malware uses this          |
